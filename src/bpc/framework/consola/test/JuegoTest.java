...
public class JuegoTest {
    public static void main(String[] args){
        ...
        EscenaTesteadora escenaTesteadora = new EscenaTesteadora(objeto);

        Juego juego = new Juego();

        Runnable juegoInicio = juego.iniciar(escenaTesteadora, Resolucion.VENTANA_VGA);
        Thread juegoComienzo = new Thread(juegoInicio);
        juegoComienzo.start();
